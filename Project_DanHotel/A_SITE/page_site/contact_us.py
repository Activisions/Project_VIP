...
class contact_Us:
    ...
    def contact_locators(self):
        ...
        return contact_name, contact_email, contact_phone, choose_hotel_dropdown, choose_hotel, choose_subject_dropdown, choose_subject, contact_note, contact_button, H1_title

    def contact_locators_error(self):
        ...
        return error_wrong_name, error_wrong_email

    #פונקציה למילוי פרטים (טלפון ,אימייל ,טלפון)
    def contact_us_fill(self, name, email, phone, nots):
        contact_name, contact_email, contact_phone, choose_hotel_dropdown, choose_hotel, choose_subject_dropdown, choose_subject, contact_note, contact_button, H1_title = self.contact_locators()
    ...
    def contact_us_fill_text(self):
        ...
        return check_text
    def contact_us_fill_text_errors(self):
        error_wrong_name,error_wrong_email = self.contact_locators_error()
        check_error_name = error_wrong_name.text
        check_error_email = error_wrong_email.text
        return check_error_name, check_error_email
